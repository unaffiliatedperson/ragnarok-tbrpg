...
bool overlord::get_input() {
 ...
 if (usr_input == "exit") {
  ...
  short id;
  std::cin >> id;
  entity_list.at(id).display_inventory();
     }
     else {
      entity_list.at(0).display_inventory();
     }
  return true;
 }
...
void overlord::trade(short entity1, short entity2, short item_id) {
    if (entity_list.at(entity1).inventory_name_return(item_id) == "") {
