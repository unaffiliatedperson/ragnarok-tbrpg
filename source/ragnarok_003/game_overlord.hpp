...
class overlord {
  ...
  public:
   ...
   void give_entity_item(int x); //gives entity tiem
   void entity_attack(unsigned char, unsigned char); //test function.
   //working with inventory more specifically
   void new_item(short ID, const char * namex, const unsigned short locationx, bool equipt=true, const unsigned char consecutivex=0,
   ...
   std::vector<std::vector<int> > * return_all_items();
