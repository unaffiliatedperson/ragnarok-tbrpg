...
bool attack(short, short); //need to do in overlord
...
entity * player22 = new entity("player22", 9999, 9999, 9999, 9999, 9999, 9999, 9999, 9999);
entity * goblin = new entity("goblin", 10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000);
Game::set_entity(player22);
Game::set_entity(goblin);
Game::Overlord.new_item(667, "Test Sword", 777, false, 2000, 2000, 2000, 2000 , 2000, 20, 22, 30000);
Game::Overlord.new_item(111, "The Altar", 772, false, 2002, 2002, 2002, 2002, 2002, 20, 22, 30002);
Game::Overlord.give_entity_item(0, 111);
Game::Overlord.give_entity_item(0, 667);
...
player22->inventory_remove(111);

std::cout << "from player22 " << player22->inventory_name_return(667) << std::endl;
std::cout << "from player22s " << player22->return_item_value(667, entity::location);
Game::Overlord.entity_attack(0, 1);
...
std::cout << std::endl << "not founds" << std::endl;
}
else {
Saves.clear();
}
