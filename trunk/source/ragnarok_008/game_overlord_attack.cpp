...
if ((entity_list.at(entity1).rtrn_alive() == false) || (entity_list.at(entity2).rtrn_alive() == false)) {
    std::cout << "You cannot attack something that is already dead!" << std::endl; _continue = false;
    }
if (entity_list.at(entity1).rtrn_location() != entity_list.at(entity2).rtrn_location()) {
    std::cout << "You cannot attack something that isnt here!" << std::endl;
    _continue = false;
    }
...
entity_list.at(entity2).set_alive();
...
entity_list.at(entity1).set_alive();
