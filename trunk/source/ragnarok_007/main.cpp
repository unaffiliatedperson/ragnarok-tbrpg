...
Game::Overlord.new_item(667, "Sword", 771, false, 20, 20, 20, 20 , 20, 20, 22, 100);
Game::Overlord.new_item(111, "The Altar", 777, false, 2002, 2002, 2002, 2002, 2002, 20, 22, 30002);

std::cout << "\/ Ragnarok Pre-Alpha 0.2.6 \\" << std::endl << "\\      coded by cipher     /" << std::endl << std::endl;
...
while (Game::playing) {
std::cout << "-> ";
if (Game::Overlord.get_input() == false) {Game::playing = false;}  //get_input handles the game function calls
}
